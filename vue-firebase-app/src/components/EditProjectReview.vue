                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="course_name" type="text"
                                        class="form-control" name="course_name" value
                                        required autofocus v-model="review.course_name" />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="course_code" type="text"
                                        ...
                                        required autofocus v-model="review.course_code" />
                                </div>
                            </div>

                            <div class="form-group row">
                                <label for="reviewer"
                                    class="col-md-4 col-form-label text-md-right">Reviewer</label>
                                ...
                                <div class="col-md-6">
                                    <select id="reviewer" class="form-control"
                                        ...
                                        <option v-for="reviewer in reviewers"
                                            :value="reviewer.id" :key="reviewer.id">
