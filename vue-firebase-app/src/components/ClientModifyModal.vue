          ...
          <div class="modal-body">
            <slot name="body">
                <div class="form-group row">
                  <label class="col-md-4 col-form-label text-md-right font-size: 1.1em"
                    >First Name</label
                  >
                  <div class="col-md-6">
                    <input
                ...
                <div class="form-group row">
                  ...
                  >
                  <div class="col-md-6">
                    <input type="email" class="form-control" value required v-model="update.value.email" />
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-md-4 col-form-label text-md-right"
                  ...
                  <div class="col-md-6">
                    <select class="form-control" required v-model="update.value.organization">
                      <option
