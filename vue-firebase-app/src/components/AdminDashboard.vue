  ...
  <div class="container scrollcontainer">
    ...
    <div v-if="in_progress_reviews.length > PAGE_SIZE">
      ...
      <button
        ...
        :disabled="in_progress_reviews.length <= in_progress_page * PAGE_SIZE"
      >
        Next
      </button>
    </div>
    ...
    <div v-if="completed_reviews.length > PAGE_SIZE">
      ...
      <button
        ...
        :disabled="completed_reviews.length <= completed_page * PAGE_SIZE"
      >
        Next
      </button>
    </div>
...
export default {
  ...
  methods: {
    ...
    nextInProgressPage() {
      if (
        this.in_progress_page * this.PAGE_SIZE <
        this.in_progress_reviews.length
      )
