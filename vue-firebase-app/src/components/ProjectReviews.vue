    ...
    <div class="container scrollcontainer">
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <select id="project" class="form-control" name="project"
                            ...
                            v-on:change="populateReviews" required
                ...
                <div>
                    <button class="btn save" id="show-modal"
                    ...
                    <tbody class="project-body">
                        <tr v-for="review in reviews" :key="review.id">
                            ...
                            <td><button title="delete" class="btn delete"
                                    @click="deleteReview(review)"></button></td>
                        </tr>
                    </tbody>
                </table>
                    ...
                    .then((result) => {
                        if (result.size > 0) {
                            ...
                            firebase
                                ...
                                .doc(this.selected_proj)
                                .update({
                                    num_reviews: firebase.firestore.FieldValue.increment(
                                        -1
                                    ),
                                    reviewer_ref: null
                                })
